...
public class Estudaintes {
    ...
    public Estudiante(){} //Cosntructor Vacio

    public Estudaintes(int idEstudainte){ //Cosntructor para la llave primaria
    ...
    public Estudiante(int idEstudiante, String nombre, String apellido, String telefono, String email){
        this.idEstudainte = idEstudiante;
        this.nombre = nombre;
        this.apellido = apellido;
        this.telefono = telefono;
        this.email = email;
